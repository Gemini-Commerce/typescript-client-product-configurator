...
export class ProductconfiguratorpropertyBulkCreateRequestCreateEntity {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "stepIdToOptionId",
            "baseName": "stepIdToOptionId",
            "type": "{ [key: string]: string; }",
            "format": ""
        },
        {
            "name": "genericProperty",
            "baseName": "genericProperty",
            "type": "ProductconfiguratorpropertyGenericProperty",
            "format": ""
        },
        {
            "name": "priceProperty",
            "baseName": "priceProperty",
            "type": "ProductconfiguratorpropertyPriceProperty",
            "format": ""
        },
        {
            "name": "weightProperty",
            "baseName": "weightProperty",
            "type": "ProductconfiguratorpropertyWeightProperty",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ProductconfiguratorpropertyBulkCreateRequestCreateEntity.attributeTypeMap;
    }
