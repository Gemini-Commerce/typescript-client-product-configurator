...
export class ConfigurationGetConfigurationFromSelectionsResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "matchedProperties",
            "type": "Array<ConfigurationProperty>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ConfigurationGetConfigurationFromSelectionsResponse.attributeTypeMap;
    }
