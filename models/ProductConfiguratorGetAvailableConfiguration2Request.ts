...
export class ProductConfiguratorGetAvailableConfiguration2Request {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "propertyFilters",
            "type": "Array<ConfigurationPropertyFilter>",
            "format": ""
        },
        {
            "name": "configuratorId",
            "baseName": "configuratorId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ProductConfiguratorGetAvailableConfiguration2Request.attributeTypeMap;
    }
