 ...
 */
export class APIAuthorizationAuthentication implements SecurityAuthentication {
    /**
...
export type AuthMethods = {
    ...
    "APIAuthorization"?: SecurityAuthentication,
...
export type AuthMethodsConfiguration = {
    "default"?: SecurityAuthentication,
    "APIAuthorization"?: ApiKeyConfiguration,
...
export function configureAuthMethods(config: AuthMethodsConfiguration | undefined): AuthMethods {
    ...
    if (config["APIAuthorization"]) {
        authMethods["APIAuthorization"] = new APIAuthorizationAuthentication(
